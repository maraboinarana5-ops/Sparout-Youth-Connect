...
import { Star, Calendar, Trophy, TrendingUp, Award, ChevronRight } from "lucide-react";
...
export default function ProgressPage() {
  ...
  const displayName = user?.name || "Champion";
    ...
    return (
      <div className="min-h-screen bg-background pb-24 flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-muted-foreground mb-6">Sign up to track your training, belt progress, and tournament history.</p>
          <Link href="/login">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold text-white" data-testid="text-progress-name">{displayName}</h1>
            </div>
          </div>
