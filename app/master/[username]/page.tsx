...
const masterData: Record<string, any> = {
  ...
  "guru-ravi": { name: "Guru Ravi Nair", styles: ["Kalaripayattu", "Silambam"], city: "Chennai", state: "Tamil Nadu", rating: 4.7, reviews: 76, price: 1000, priceMonthly: 6000, experience: 20, verified: true, students: 60, bio: "20 years mastering the ancient Kerala art of Kalaripayattu, trained at the prestigious CVN Kalari in Thiruvananthapuram. Now based in Chennai, bringing authentic South Indian martial arts to a new generation.\n\nI teach traditional Kalaripayattu forms, weapon combat (sword, shield, urumi), Marma therapy, and Silambam staff fighting. My classes blend rigorous physical training with the spiritual philosophy of the warrior tradition.", certifications: ["CVN Kalari Certified Gurukkol", "Silambam Federation of India - Senior Instructor", "Ayurvedic Marma Therapy Practitioner"], formats: ["In-Person", "Group Class"], phone: "+91 76543 21098", whatsapp: "+91 76543 21098", email: "ravi@sparout.com", schedule: [{ day: "Mon", time: "5:30 AM - 7:30 AM" }, { day: "Wed", time: "5:30 AM - 7:30 AM" }, { day: "Fri", time: "5:30 AM - 7:30 AM" }, { day: "Sun", time: "7:00 AM - 9:00 AM" }], gender: "Male" },
};
