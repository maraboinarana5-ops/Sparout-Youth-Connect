...
const sampleMasters = [
  { id: 1, username: "guru-rajesh", name: "Guru Rajesh Kumar", styles: ["Karate", "Judo"], city: "Mumbai", state: "Maharashtra", rating: 4.9, reviews: 128, price: 800, experience: 15, verified: true, format: "In-Person", gender: "Male", students: 45, bio: "3rd Dan Black Belt with 15 years of competitive and teaching experience across India." },
  { id: 2, username: "sensei-priya", name: "Sensei Priya Sharma", styles: ["Taekwondo", "Kickboxing"], city: "Hyderabad", state: "Telangana", rating: 4.8, reviews: 94, price: 600, experience: 10, verified: true, format: "In-Person", gender: "Female", students: 32, bio: "National Taekwondo gold medalist. Specializes in women's self-defense and competitive sparring." },
  { id: 3, username: "coach-arjun", name: "Coach Arjun Reddy", styles: ["MMA", "Boxing"], city: "Delhi", state: "Delhi", rating: 4.7, reviews: 76, price: 1200, experience: 12, verified: true, format: "In-Person", gender: "Male", students: 60, bio: "Former national MMA champion and pro boxer. Trains fighters for competitive circuits across India." },
  { id: 4, username: "master-deepa", name: "Master Deepa Nair", styles: ["Jiu-Jitsu", "Judo"], city: "Bangalore", state: "Karnataka", rating: 4.9, reviews: 63, price: 1000, experience: 14, verified: true, format: "Private Session", gender: "Female", students: 25, bio: "India's first female BJJ brown belt. National Judo silver medalist. Empowering women through grappling arts." },
  { id: 5, username: "guru-suresh", name: "Guru Suresh Pillai", styles: ["Muay Thai", "Kalaripayattu"], city: "Chennai", state: "Tamil Nadu", rating: 4.8, reviews: 52, price: 700, experience: 18, verified: true, format: "Group Class", gender: "Male", students: 80, bio: "18 years of Muay Thai and traditional Kalaripayattu. Blending Thai and Indian striking arts." },
  { id: 6, username: "coach-amit", name: "Coach Amit Patel", styles: ["Kickboxing", "Boxing"], city: "Pune", state: "Maharashtra", rating: 4.7, reviews: 89, price: 900, experience: 8, verified: true, format: "In-Person", gender: "Male", students: 55, bio: "Former state boxing champion. Expert in kickboxing and western boxing techniques." },
];
