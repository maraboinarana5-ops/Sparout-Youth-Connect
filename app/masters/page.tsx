...
const sampleMasters = [
  ...
  { id: 3, username: "master-chen", name: "Master Chen Wei", styles: ["Kung Fu", "Tai Chi"], city: "Delhi", state: "Delhi", rating: 4.7, reviews: 76, price: 1000, experience: 20, verified: true, format: "Online", gender: "Male", students: 60, bio: "Shaolin-trained master bringing authentic Chinese martial arts to India." },
  { id: 4, username: "guru-arjun", name: "Guru Arjun Singh", styles: ["Gatka", "Wrestling"], city: "Amritsar", state: "Punjab", rating: 4.9, reviews: 52, price: 600, experience: 25, verified: true, format: "Group Class", gender: "Male", students: 80, bio: "Preserving the ancient Sikh martial art of Gatka for the next generation." },
  { id: 5, username: "sensei-akiko", name: "Sensei Akiko Tanaka", styles: ["Jiu-Jitsu", "Judo"], city: "Bangalore", state: "Karnataka", rating: 4.6, reviews: 63, price: 1500, experience: 12, verified: false, format: "Private Session", gender: "Female", students: 25, bio: "Brazilian Jiu-Jitsu black belt. Trained under the Gracie family." },
